...
class RoutingPractice extends React.Component<
  RoutingPracticeProps,
  RoutingPracticeState
> {
  constructor(props: RoutingPracticeProps) {
    super(props);

    const isLoginFromSession =
      sessionStorage.getItem(IS_LOGIN_SESSION_KEY) === "true";
